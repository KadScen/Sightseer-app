...
function SignInUp() {
  ...
  useEffect(() => {
    ...
    submitSignup.addEventListener("click", function (e) {
      ...
      let profilePicture =
        "https://assets.dryicons.com/uploads/icon/svg/3349/black_business_user.svg";
    ...
    <div className="signInUpComponent">
      <div className="loginDiv">
        <div className="wrapper fadeInDown">
          <div id="formContent">
            {/* <!-- Tabs Titles --> */}
            <h2 id="signInTab" className="active underlineHover">
              {" "}
              Sign In{" "}
            </h2>
            <h2 id="signUpTab" className="inactive underlineHover">
              Sign Up{" "}
            </h2>
